...
def load_and_index_dataset():
    ...
    for file_name in DATASET_FILES:
        ...
        try:
            # Membaca file bersih yang sudah dipreprocessing (dengan kolom 'konten_bersih')
...
def search_and_rank(query, top_n=5):
    ...
    print(f"\nDitemukan {len(relevant_indices)} dokumen relevan (dari {len(df_documents)} total).")
...
def main_cli():
    ...
    # Catatan: Whoosh menyimpan skema (nama kolom) di dalam index-nya.
    # Pengecekan sederhana menggunakan folder index.
